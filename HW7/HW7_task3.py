...
def tic_tac_toe_checker(board: List[List]) -> str:
    for i in enumerate(board):
        ...
        if (
                ...
                board[i[0]][0] == board[i[0]][1] == board[i[0]][1] != "-"
                #we check the victory horizontally
            ...
            return f"{i[1][0]} wins!"
                ...
                #we check the victory vertically
        ):
    ...
    if (
        ...
        return f"{board[1][1]} wins!" #we check the victory horizontally
